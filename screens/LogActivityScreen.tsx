                ...
                <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 animate-fade-in" onClick={handleCloseModal}>
                    <div className="bg-card dark:bg-dark-card rounded-2xl p-6 shadow-xl w-11/12 max-w-sm animate-slide-in-up" onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className="flex gap-4 mt-6">
                            <button onClick={handleCloseModal} className="flex-1 py-3 rounded-xl bg-light-gray dark:bg-dark-border text-text-main dark:text-dark-text-main font-semibold transition-transform active:scale-95">Cancel</button>
                            <button onClick={handleSaveNewActivity} className="flex-1 py-3 rounded-xl bg-primary text-white font-semibold transition-transform active:scale-95">Save</button>
                        </div>
                    </div>
                </div>
            )}
