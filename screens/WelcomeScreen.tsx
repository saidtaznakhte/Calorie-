...
const WelcomeScreen: React.FC = () => {
    ...
    return (
        <div className="max-w-md mx-auto h-screen bg-background dark:bg-dark-background font-sans flex flex-col justify-center items-center p-8 text-center">
            <h1 className="text-4xl font-bold text-primary mb-2 font-montserrat">Welcome Back!</h1>
            ...
            <div className="w-full grid grid-cols-2 gap-6 mb-12">
                {users.map(profile => (
                    ...
                    >
                        ...
                        <span className="font-bold text-lg text-text-main dark:text-dark-text-main font-montserrat">{profile.name}</span>
                    </button>
                ))}
                <button 
                ...
                >
                    ...
                    <span className="font-bold text-lg text-text-main dark:text-dark-text-main font-montserrat">Add Profile</span>
                </button>
            </div>
        </div>
    );
