...
export const analyzeMealPhoto = async (base64Image) => {
    if (!API_KEY) {
...
export const searchFood = async (query) => {
    ...
    if (!API_KEY) {
        ...
        const mockResults = await new Promise(resolve => setTimeout(() => {
...
export const getAIPersonalizedSuggestion = async (payload) => {
    if (!API_KEY) {
        // Mock data
        return new Promise(resolve => setTimeout(() => resolve([
